...
# Register SwigPyIterator in _pymitlm:
_pymitlm.SwigPyIterator_swigregister(SwigPyIterator)
...
class StringVector(object):
    ...
    def __init__(self, *args):
        _pymitlm.StringVector_swiginit(self, _pymitlm.new_StringVector(*args))
...
# Register StringVector in _pymitlm:
_pymitlm.StringVector_swigregister(StringVector)

class PyMitlm(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, corpus, order, smoothing, unk):
        _pymitlm.PyMitlm_swiginit(self, _pymitlm.new_PyMitlm(corpus, order, smoothing, unk))
...
# Register PyMitlm in _pymitlm:
_pymitlm.PyMitlm_swigregister(PyMitlm)
